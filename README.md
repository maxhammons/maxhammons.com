...
| `content/pages/` | Per-page JSON from the review pass: alt text for every image, copy fixes as find/replace, captions to keep (`keep_captions`), open questions. | Yes, hand-edit alt text, add copy fixes, or list a caption to keep here. |
